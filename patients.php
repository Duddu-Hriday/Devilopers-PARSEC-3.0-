...
{   echo "<table><tr><th>Patient Name</th><th>Age</th><th>Diabetes</th><th>Report</th></th></tr>";
    while($row = $result->fetch_assoc())
    {
        echo "<tr><td>".$row['name']."</td><td>".$row['age']."</td><td>".$row['diabetes']."</td><td>".$row['report']."</td><td><a class='main' href='images/".$row['report']."'>Download</a></td></tr>";
    }
}
}
else
